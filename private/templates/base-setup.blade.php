...
<div class="wrapper wrapper--content" id="default-structure">
    ...
    <p>Headstart employs a clean folder structure, and manages the included bits and pieces for you.<br>Here&#39;s what&#39;s included by default:</p>
    <ul>
    ...
    <hr id="misc">
    <h2>Miscellaneous</h2>
    <p>The <code class="language-none">misc</code> directory contains files which will only be added when making a <a href="{{URL::to('/')}}/building#production">production ready build</a>. This is what you&#39;ll find inside of it:</p>
    <ul>

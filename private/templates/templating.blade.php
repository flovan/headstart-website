...
<div class="wrapper wrapper--content language-markup">
    ...
    <p class="report--warning"><strong>Note:</strong> Using <a href="http://emberjs.com">Ember</a> in combination with Headstart <a href="https://github.com/flovan/headstart/issues/26">will break the templating functionality</a>.</p>

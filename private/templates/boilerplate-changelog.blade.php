...
<div class="wrapper wrapper--content">
	...
	<h2>1.2.0</h2>
	<ul>
		<li>Removed <code class="language-none">$base-font-size</code> variable from <code class="language-none">_config_global.scss</code> in favour of just using <code class="language-css">100%</code>.</li>
		...
		<li>Dried out the <code class="language-sass">column()</code> mixin, resulting in less CSS. Yay! Big thanks to Team Sass for their <a href="https://github.com/team-sass/toolkit">Toolkit</a>.</li>
	</ul>
	<hr id="r110">
	<h2>1.1.0</h2>
	<ul>

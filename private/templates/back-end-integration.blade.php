...
<div class="wrapper wrapper--content">
    ...
    <p>First, all the Headstart project files should be moved to a <code class="language-none">private</code> folder within the Laravel setup, and the <code class="language-none">.html</code> extensions should be changed to <code class="language-none">.blade.php</code>.</p>
